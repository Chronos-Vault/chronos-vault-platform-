...
import { Diamond, Hexagon, Circle } from 'lucide-react';
...
interface IntegratedWalletConnectorProps {
  isOpen: boolean;
  onClose: () => void;
...
const IntegratedWalletConnector: React.FC<IntegratedWalletConnectorProps> = ({
  isOpen,
  onClose,
  initialChain = 'ton',
  onWalletConnected
    ...
    <Dialog open={isOpen} onOpenChange={(open) => !connecting && !open && onClose()}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Choose your blockchain and connect your wallet to access the Chronos Vault platform.
          </DialogDescription>
        </DialogHeader>
...
export default IntegratedWalletConnector;
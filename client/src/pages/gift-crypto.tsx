  ...
  return (
    <div className="container max-w-7xl py-10">
      ...
      <div className="mb-8 text-center">
        <h1 className="text-4xl font-bold mb-3 bg-clip-text text-transparent bg-gradient-to-r from-[#6B00D7] to-[#FF5AF7]">
          🎁 Crypto Gift Vaults
        </h1>
        <p className="text-gray-400 text-lg max-w-2xl mx-auto">
          Send crypto gifts with time-locks, multi-chain support, and Trinity Protocol™ security
        </p>
      </div>

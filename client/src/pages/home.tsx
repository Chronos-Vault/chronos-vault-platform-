  ...
  return (
    <div className="flex flex-col bg-black text-white min-h-screen overflow-hidden">
      ...
      <main className="flex-1 relative z-10">
        ...
        {/* Mobile SDK Section */}
        <section className="py-16 bg-gradient-to-b from-black to-[#0a0014] relative overflow-hidden">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              >
                <span className="text-xs font-medium text-[#FF5AF7] tracking-wider uppercase flex items-center">
                  <Globe className="w-3.5 h-3.5 text-[#FF5AF7] mr-1.5" />
              ...
              >
                Take Chronos Vault with you anywhere. Our mobile SDK enables developers to integrate our security architecture into iOS and Android applications.
              </motion.p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-12">
              ...
              >
                ...
                <div className="relative bg-gradient-to-b from-black/80 to-[#0a0014] backdrop-blur-lg border border-[#6B00D7]/20 hover:border-[#6B00D7]/40 rounded-2xl p-6 transition-all duration-300 shadow-glow overflow-hidden group-hover:shadow-[0_0_25px_rgba(107,0,215,0.3)]">
                  ...
                  <h3 className="text-xl md:text-2xl font-bold text-white mt-4 mb-3 flex items-center">
                    <div className="mr-3 p-2 rounded-lg bg-gradient-to-br from-[#6B00D7]/20 to-[#FF5AF7]/10 flex items-center justify-center">
                      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor" style={{color: '#FF5AF7'}}>
                        <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/>
                      </svg>
                    </div>
                    <span className="bg-clip-text text-transparent bg-gradient-to-r from-white to-white via-[#FF5AF7] animate-gradient-text">iOS Application</span>
                  </h3>
                  
                  <p className="text-gray-300 mb-5 pl-1">
                    Install the Chronos Vault SDK directly on your iPhone or iPad for secure mobile vault management with biometric authentication.
                  </p>
                  
                  <div className="bg-black/60 rounded-md p-3 border border-[#6B00D7]/20 group-hover:border-[#6B00D7]/40 text-xs font-mono text-gray-300 mb-4 overflow-x-auto transition-all duration-300">
                    <div className="text-purple-400">npm install @chronos-vault/mobile-sdk</div>
                    <div className="text-gray-500">// React Native iOS Integration</div>
                  ...
                  <div className="flex gap-3">
                    <button 
                      onClick={() => {
                        ...
                        link.href = 'data:application/octet-stream;base64,' + btoa(JSON.stringify({
                        ...
                        link.download = 'chronos-vault-sdk-ios.json';
                        link.click();
                      }}
              ...
              >
                ...
                <div className="relative bg-gradient-to-b from-black/80 to-[#0a0014] backdrop-blur-lg border border-[#6B00D7]/20 hover:border-[#6B00D7]/40 rounded-2xl p-6 transition-all duration-300 shadow-glow overflow-hidden group-hover:shadow-[0_0_25px_rgba(107,0,215,0.3)]">
                  ...
                  <h3 className="text-xl md:text-2xl font-bold text-white mt-4 mb-3 flex items-center">
                    <div className="mr-3 p-2 rounded-lg bg-gradient-to-br from-[#6B00D7]/20 to-[#FF5AF7]/10 flex items-center justify-center">
                      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor" style={{color: '#FF5AF7'}}>
                        <path d="M17.523 15.3414c-.5511 0-.9993-.4486-.9993-.9997s.4482-.9993.9993-.9993c.5511 0 .9993.4486.9993.9993s-.4482.9997-.9993.9997m-11.046 0c-.5511 0-.9993-.4486-.9993-.9997s.4482-.9993.9993-.9993c.5511 0 .9993.4486.9993.9993s-.4482.9997-.9993.9997m11.4045-6.02l1.9973-3.4592a.416.416 0 00-.1518-.5972.416.416 0 00-.5972.1518l-2.0223 3.503C15.5902 8.2439 13.8533 7.8508 12 7.8508s-3.5902.3931-5.1333 1.0989L4.8442 5.4467a.4161.4161 0 00-.5972-.1518.416.416 0 00-.1518.5972L6.0952 9.321C3.7831 10.7808 2.3542 13.1951 2.3542 15.9997h19.2916c0-2.8046-1.4289-5.2189-3.741-6.6783"/>
                      </svg>
                    </div>
                    <span className="bg-clip-text text-transparent bg-gradient-to-r from-white to-white via-[#FF5AF7] animate-gradient-text">Android Application</span>
                  </h3>
                  
                  <p className="text-gray-300 mb-5 pl-1">
                    Integrate Chronos Vault security into your Android applications with our comprehensive SDK supporting all Android devices.
                  </p>
                  
                  <div className="bg-black/60 rounded-md p-3 border border-[#6B00D7]/20 group-hover:border-[#6B00D7]/40 text-xs font-mono text-gray-300 mb-4 overflow-x-auto transition-all duration-300">
                    <div className="text-purple-400">npm install @chronos-vault/mobile-sdk</div>
                    <div className="text-gray-500">// React Native Android Integration</div>
                    <div className="text-emerald-400">import ChronosVaultSDK from '@chronos-vault/mobile-sdk';</div>
                  </div>
                    ...
                    <button 
                      onClick={() => {
                        ...
                        link.href = 'data:application/octet-stream;base64,' + btoa(JSON.stringify({
                          name: '@chronos-vault/mobile-sdk',
                          version: '1.0.0',
                          description: 'Chronos Vault Mobile SDK for Android',
                          main: 'ChronosVaultSDK.js',
                          dependencies: {
                            'react-native': '^0.73.0',
                            'react-native-keychain': '^8.1.3',
                        ...
                        link.download = 'chronos-vault-sdk-android.json';
                        link.click();
                      }}
                      className="flex-1 bg-gradient-to-r from-[#6B00D7] to-[#FF5AF7] text-white py-2 px-4 rounded-lg font-medium hover:shadow-lg hover:shadow-[#6B00D7]/50 transition-all duration-300 text-center"
                    >
            ...
            >
              <div className="bg-gradient-to-b from-black/80 to-[#0a0014] backdrop-blur-lg border border-[#6B00D7]/20 rounded-2xl p-6">
                <h3 className="text-xl font-bold text-white mb-4 flex items-center">
                  <KeyRound className="text-[#FF5AF7] w-5 h-5 mr-2" />
                  Quick Integration Example
                </h3>
                
                <div className="bg-black/60 rounded-lg p-4 border border-[#6B00D7]/20 text-sm font-mono text-gray-300 overflow-x-auto">
                  <div className="text-gray-500">// Initialize Chronos Vault SDK</div>
                  <div className="text-purple-400">const sdk = new ChronosVaultSDK({`{`}</div>
                  <div className="pl-4"><span className="text-yellow-400">apiEndpoint</span>: <span className="text-green-400">'https://your-app.replit.dev'</span>,</div>
                  ...
                  <div className="text-purple-400">{`}`});</div>
                  <br />
                  <div className="text-gray-500">// Authenticate and create vault</div>
                  <div className="text-emerald-400">await sdk.initialize();</div>
                  <div className="text-emerald-400">await sdk.authenticate();</div>
                  <div className="text-emerald-400">const vault = await sdk.createVault(vaultConfig);</div>
                </div>
                
                <div className="flex items-center justify-between mt-4 pt-4 border-t border-[#6B00D7]/20">
                  <div className="flex items-center gap-2 text-sm text-gray-400">
                    <CheckCircle className="w-4 h-4 text-[#FF5AF7]" />
                    <span>Works with your existing backend</span>
                  </div>

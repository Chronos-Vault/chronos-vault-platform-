      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <section className="mt-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Leverages Ethereum's battle-tested security and robust consensus mechanisms as the primary security foundation.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Utilizes Solana's high-speed transactions and low-cost operations for quick access and responsive vault interactions.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Employs TON's scalable architecture as a resilient fallback system, ensuring continuous vault access under any circumstances.</p>
                  </div>
                </div>
              </div>
            ...
            <div className="relative">
              ...
              <div className="relative bg-[#1A1A1A] p-6 rounded-lg border border-[#333] z-10">
                <div className="rounded-lg bg-[#0A0A0A] p-6 border border-[#333]">
                  <h3 className="text-xl font-semibold mb-4 text-white">How Triple-Chain Security Works</h3>
                  
                  <div className="space-y-6">
                    <div className="space-y-2">
                      <div className="font-medium text-[#FF5AF7]">1. Data Distribution</div>
                      <p className="text-gray-300 text-sm">When you create a vault, essential vault data is cryptographically split and distributed across the three blockchain networks using Shamir's Secret Sharing algorithm.</p>
                    </div>
                    
                    <div className="space-y-2">
                      <div className="font-medium text-[#FF5AF7]">2. Synchronization Mechanism</div>
                      <p className="text-gray-300 text-sm">Our cross-chain validator network continuously monitors each blockchain for data consistency and integrity using secure multi-party computation protocols.</p>
                    </div>
                    
                    <div className="space-y-2">
                      <div className="font-medium text-[#FF5AF7]">3. Fallback Protocols</div>
                      <p className="text-gray-300 text-sm">In the event that any network becomes unavailable, the system automatically reconstructs vault data from the remaining networks with zero downtime.</p>
                    </div>
                    
                    <div className="space-y-2">
                      <div className="font-medium text-[#FF5AF7]">4. Chain-Specific Advantages</div>
                      <p className="text-gray-300 text-sm">Each chain provides unique security benefits: Ethereum's immutability, Solana's performance, and TON's capacity for complex recovery logic.</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="mt-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1 relative">
              ...
              <div className="relative bg-[#1A1A1A] p-6 rounded-lg border border-[#333] z-10">
                <div className="rounded-lg bg-[#0A0A0A] p-6 border border-[#333]">
                  <h3 className="text-xl font-semibold mb-4 text-white">Technical Implementation</h3>
                  
                  <div className="space-y-6">
                    <div className="space-y-2">
                      <div className="font-medium text-[#FF5AF7]">Hashlock Technology</div>
                      <p className="text-gray-300 text-sm">Our atomic swaps utilize Hash Time-Locked Contracts (HTLCs) to ensure that either both sides of a swap complete successfully or neither does, eliminating counterparty risk.</p>
                    </div>
                    
                    <div className="space-y-2">
                      <div className="font-medium text-[#FF5AF7]">Trustless Infrastructure</div>
                      <p className="text-gray-300 text-sm">The entire swap process is handled by smart contracts with no intermediary custody, maintaining the trustless nature of decentralized technology.</p>
                    </div>
                    
                    <div className="space-y-2">
                      <div className="font-medium text-[#FF5AF7]">Price Oracles</div>
                      <p className="text-gray-300 text-sm">Integration with Chainlink price feeds ensures that price-triggered swaps execute based on reliable, tamper-proof market data.</p>
                    </div>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Convert assets between Ethereum, Solana, TON, and other supported chains without ever leaving the security of your vault.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Set price thresholds that automatically trigger conversions between assets, allowing your vault to react to market conditions.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Choose from predefined strategies that optimize for growth, stability, or balanced returns while maintaining the security of your time-locked assets.</p>
                  </div>
                </div>
              </div>
              
              <Button
                className="bg-gradient-to-r from-[#FF5AF7] to-blue-500 hover:from-[#FF46E8] hover:to-blue-600 text-white font-bold rounded-lg px-6 py-3 shadow-glow hover:shadow-lg hover:shadow-[#FF5AF7]/40 transition-all"
                onClick={() => setLocation("/create-vault")}
              >
                Try Atomic Swaps
              </Button>
        ...
        <section className="mt-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Your vault attachments are stored using content-addressing, meaning they can be retrieved from any IPFS node worldwide without relying on centralized servers.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Critical vault data is permanently archived on Arweave's blockweave, backed by an endowment that ensures storage for hundreds of years with a single payment.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Your documents, images, and other media are stored across a distributed network, making them resistant to censorship and single points of failure.</p>
                  </div>
                </div>
              </div>
              
              <Button
                className="bg-gradient-to-r from-[#00C9FF] to-teal-500 hover:from-[#00B8E6] hover:to-teal-600 text-white font-bold rounded-lg px-6 py-3 shadow-glow hover:shadow-lg hover:shadow-[#00C9FF]/40 transition-all"
                onClick={() => setLocation("/create-vault")}
              >
            ...
            <div className="bg-gradient-to-br from-[#1A1A1A]/95 to-[#131313]/95 p-6 rounded-lg border border-[#333] space-y-6">
              <div className="bg-gradient-to-br from-[#1A1A1A] to-[#0F0F0F] p-5 rounded-lg border border-[#333] relative overflow-hidden">
                <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-b from-[#00C9FF]/20 to-transparent rounded-bl-3xl -mr-5 -mt-5 z-0"></div>
                <div className="relative z-10">
                  <div className="flex items-center mb-4">
                    <div className="bg-[#00C9FF]/20 p-2 rounded-full mr-3">
                      <i className="ri-file-text-line text-[#00C9FF] text-xl"></i>
                    </div>
                    <h4 className="font-semibold text-white">Data Permanence Comparison</h4>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-3 gap-2 text-center text-xs font-medium">
                      ...
                      <div className="text-gray-500">Censorship Resistance</div>
                    </div>
                    
                    <div className="grid grid-cols-3 gap-2 py-2 border-b border-gray-800">
                      <div className="text-white text-sm">Traditional Cloud</div>
                    ...
                    <div className="grid grid-cols-3 gap-2 py-2 border-b border-gray-800">
                      <div className="text-white text-sm">IPFS Network</div>
                      <div className="flex justify-center">
                        <div className="w-16 h-2 bg-gray-800 rounded-full overflow-hidden">
                    ...
                    <div className="grid grid-cols-3 gap-2 py-2">
                      <div className="text-white text-sm">Arweave</div>
                      <div className="flex justify-center">
                        <div className="w-16 h-2 bg-gray-800 rounded-full overflow-hidden">
                          <div className="w-16 h-full bg-[#00C9FF] rounded-full"></div>
                        </div>
                      </div>
                      <div className="flex justify-center">
                        <div className="w-16 h-2 bg-gray-800 rounded-full overflow-hidden">
              ...
              <div className="p-4 bg-[#00C9FF]/10 rounded-lg border border-[#00C9FF]/30">
                <h4 className="font-medium text-[#00C9FF] mb-2 flex items-center">
                  <i className="ri-lock-line mr-2"></i>
                  End-to-End Encryption
                </h4>
                <p className="text-sm text-gray-300">All data stored on IPFS and Arweave is encrypted before leaving your device. Only you and your designated beneficiaries can decrypt and access your vault contents, providing privacy while leveraging public networks.</p>
              </div>
                ...
                <div className="inline-block">
                  <div className="flex items-center gap-3 text-sm">
                    <div className="flex items-center">
                      <div className="w-3 h-3 rounded-full bg-[#00C9FF] mr-1.5"></div>
        ...
        <section className="mt-24 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
              <Button 
                className="bg-gradient-to-r from-[#6B00D7] to-[#FF5AF7] hover:from-[#5500AB] hover:to-[#FF46E8] text-white font-bold rounded-lg px-8 py-4 text-lg shadow-glow hover:shadow-lg hover:shadow-[#FF5AF7]/40 transition-all w-full md:w-auto"
                onClick={() => setLocation("/create-vault")}
              >
                Create Your Vault
              </Button>
              ...
              <Button
                variant="outline"
                className="border-2 border-[#6B00D7] text-white hover:bg-[#6B00D7]/10 hover:text-white font-bold rounded-lg px-8 py-4 text-lg transition-all w-full md:w-auto"
                onClick={() => setLocation("/")}
              >
                Back to Home
              </Button>

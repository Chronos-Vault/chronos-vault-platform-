  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-[#1C0533] to-black text-white pb-16">
      ...
      <div className="container mx-auto px-4 pt-8 relative z-10">
        ...
        <motion.div 
          className="w-full mb-10 rounded-xl overflow-hidden"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
        >
          <div className="relative bg-black/30 backdrop-blur-md border border-purple-500/20 rounded-xl p-6 overflow-hidden">
            {/* Blockchain Network Visualization */}
            <div className="absolute inset-0 overflow-hidden">
              <svg className="absolute inset-0 w-full h-full opacity-20" viewBox="0 0 1000 200">
                {/* Network Core */}
                <circle cx="500" cy="100" r="15" fill="url(#coreGradient)" className="animate-pulse-slow"></circle>
                <circle cx="500" cy="100" r="30" fill="none" stroke="url(#coreStrokeGradient)" strokeWidth="1" strokeDasharray="5,5" className="animate-spin-slow"></circle>
                
                {/* Network Nodes */}
                <circle cx="300" cy="60" r="8" fill="url(#ethGradient)" className="animate-pulse"></circle>
                <circle cx="700" cy="60" r="8" fill="url(#solGradient)" className="animate-pulse animation-delay-700"></circle>
                <circle cx="400" cy="160" r="8" fill="url(#tonGradient)" className="animate-pulse animation-delay-1400"></circle>
                <circle cx="600" cy="160" r="8" fill="url(#btcGradient)" className="animate-pulse animation-delay-2100"></circle>
                
                {/* Connection Lines */}
                <path d="M500,100 L300,60" stroke="url(#purpleLineGradient)" strokeWidth="1.5" strokeDasharray="4,4" className="animate-dash-offset"></path>
                <path d="M500,100 L700,60" stroke="url(#greenLineGradient)" strokeWidth="1.5" strokeDasharray="4,4" className="animate-dash-offset animation-delay-700"></path>
                <path d="M500,100 L400,160" stroke="url(#blueLineGradient)" strokeWidth="1.5" strokeDasharray="4,4" className="animate-dash-offset animation-delay-1400"></path>
                <path d="M500,100 L600,160" stroke="url(#amberLineGradient)" strokeWidth="1.5" strokeDasharray="4,4" className="animate-dash-offset animation-delay-2100"></path>
                
                {/* Data Transfer Packets */}
                <circle cx="0" cy="0" r="3" fill="#FFFFFF" className="animate-data-packet1">
                  <animateMotion path="M300,60 L500,100" dur="2s" repeatCount="indefinite" />
                </circle>
                <circle cx="0" cy="0" r="3" fill="#FFFFFF" className="animate-data-packet2">
                  <animateMotion path="M700,60 L500,100" dur="3s" repeatCount="indefinite" />
                </circle>
                <circle cx="0" cy="0" r="3" fill="#FFFFFF" className="animate-data-packet3">
                  <animateMotion path="M400,160 L500,100" dur="2.5s" repeatCount="indefinite" />
                </circle>
                <circle cx="0" cy="0" r="3" fill="#FFFFFF" className="animate-data-packet4">
                  <animateMotion path="M600,160 L500,100" dur="3.5s" repeatCount="indefinite" />
                </circle>
                ...
                <defs>
                  ...
                  <linearGradient id="coreStrokeGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                    <stop offset="0%" stopColor="#7C3AED" stopOpacity="1" />
                    <stop offset="100%" stopColor="#2563EB" stopOpacity="1" />
                  </linearGradient>
                  <radialGradient id="ethGradient" cx="50%" cy="50%" r="50%" fx="50%" fy="50%">
                  ...
                  <radialGradient id="tonGradient" cx="50%" cy="50%" r="50%" fx="50%" fy="50%">
                    <stop offset="0%" stopColor="#FFFFFF" stopOpacity="0.8" />
                    <stop offset="100%" stopColor="#2563EB" stopOpacity="0.4" />
                  </radialGradient>
                  <radialGradient id="btcGradient" cx="50%" cy="50%" r="50%" fx="50%" fy="50%">
                    <stop offset="0%" stopColor="#FFFFFF" stopOpacity="0.8" />
              ...
              <div className="flex items-center gap-4">
                <div className="flex -space-x-3">
                  ...
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-900 to-blue-600 flex items-center justify-center border-2 border-blue-500 relative z-20 shadow-lg shadow-blue-900/30">
                    ...
                    <img src="https://cryptologos.cc/logos/toncoin-ton-logo.svg" alt="TON" className="h-6 w-6" />
                  </div>
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">The most advanced multi-chain architecture available anywhere</p>
                </div>
              </div>
              
              <div className="flex gap-2">
                <div className="bg-black/40 backdrop-blur-md border border-purple-500/30 rounded-lg p-1.5 px-3 text-xs flex items-center gap-1.5 shadow-inner">
                  <Shield className="h-3.5 w-3.5 text-purple-400" />
                  <span className="text-gray-300">Military-Grade Security</span>
                </div>
                <div className="bg-black/40 backdrop-blur-md border border-blue-500/30 rounded-lg p-1.5 px-3 text-xs flex items-center gap-1.5 shadow-inner">
